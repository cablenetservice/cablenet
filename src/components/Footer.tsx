      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <a href="tel:+18334574435" className="flex items-center space-x-2 text-foreground hover:text-black dark:hover:text-white transition-all mb-2">
              <Phone className="w-4 h-4" />
              <span className="font-semibold">(833) 457-4435</span>
            </a>
        ...
        <div className="pt-8 border-t border-border text-center text-muted-foreground text-sm">
          Â© {new Date().getFullYear()} Cable & Net Services. All rights reserved. | Owned by Carol Jordan
        </div>
      </div>
    </footer>
  );
